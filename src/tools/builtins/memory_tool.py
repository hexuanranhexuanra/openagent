"""Per-peer isolated memory filesystem tool, matching TS tools/builtin/memory.ts."""
...
MEMORY_ROOT = Path("data/memories")
...
async def _execute(args: dict) -> str:
    ...
    if command == "view":
        ...
        return json.dumps({"error": f"Unknown command: {command}. Use view, create, edit, delete, ls."})


memory_tool = ToolHandler(
    definition=ToolDefinition(
        name="memory",
        description="Persistent per-user memory filesystem. Commands: view, create, edit, delete, ls.",
        parameters={
            "type": "object",
            "properties": {
                "command": {"type": "string", "description": "Command: view, create, edit, delete, ls"},
                "path": {"type": "string", "description": "File path relative to memory root"},
                "content": {"type": "string", "description": "[create, edit] File content"},
                "peerId": {"type": "string", "description": "User ID for workspace isolation (default: 'default')"},
            },
